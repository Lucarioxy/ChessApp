...
export default function ActiveGame() {
  ...
  const Overlayfunction = async () => {
    ...
    return(
      ...
      <nav className="bg-gray-800 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <span className="text-white text-3xl font-bold">Knight's Quest</span>
          </div>
      ...
      <div className="bg-slate-900 ChessBoard h-full relative">
        {/* Game Info and Player Status */}
        <div className="absolute top-[68px] left-24 w-[24rem] h-[12rem] bg-slate-600 text-white p-4 rounded-lg shadow-lg">
        ...
        {/* Chat Box */}
        <div className="bg-slate-600 w-96 h-96 flex absolute top-72 left-24 rounded-xl p-4">
        ...
        <div className="relative">
          <div className="flex flex-col absolute bottom-64 right-80 mt-7">
