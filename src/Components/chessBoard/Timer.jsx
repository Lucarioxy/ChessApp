...
export default function CountDown({ seconds }) {
  ...
  return (
    <div className='absolute'>
      <div className='absolute items-center bg-amber-700 py-8 place-items-center rounded-md w-56 h-32 px-3 '>
        <div className='text-5xl bg-amber-500 flex justify-center px-2 rounded'>{formatTimer(countdown)}</div> {/* Adjust font size here */}
